...
# modules/central_manager/variables.tf (GCP Version)
...
variable "guardium_image_id" {
  type        = string
  description = "Guardium image ID (aggregator image for Central Manager)"
}
...
variable "phase" {
  type        = string
  default     = "1"
  description = "Deployment phase: '1' = VM + basic config, '2' = VM + full Central Manager config"
